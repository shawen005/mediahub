                ...
                <div class="container">
                            ...
                            <div id="owl-single-product" class="owl-carousel">
                                <div class="single-product-gallery-item" id="slide1">
                                    <a data-rel="prettyphoto" href="assets/images/products/product-gallery-01.jpg">
                                        <img class="img-responsive" alt="" src="{{ productImage($product->image) }}" data-echo="assets/images/products/product-gallery-01.jpg" />
                                    </a>
                                ...
                                <div class="single-product-gallery-item" id="slide3">
                                    <a data-rel="prettyphoto" href="{{asset('img/images/products/product-gallery-01.jpg')}}">
                                        <img class="img-responsive" alt="" src="{{ productImage($product->image) }}" data-echo="assets/images/products/product-gallery-01.jpg" />
                                    </a>
                                </div><!-- /.single-product-gallery-item -->
                    ...
                    <div class="no-margin col-xs-12 col-sm-7 body-holder">
                        <div class="body">
                            ...
                            <div class="excerpt">
                                <p> Integer id purus ultricies nunc tincidunt congue vitae nec felis. Vivamus sit amet nisl convallis, faucibus risus in, suscipit sapien. Vestibulum egestas interdum tellus id venenatis.</p>
                            </div>

                            <div class="prices">
                                <div class="price-current">{{ $product->presentPrice() }}</div>
